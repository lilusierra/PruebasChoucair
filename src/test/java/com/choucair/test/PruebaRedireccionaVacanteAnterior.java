...
public class PruebaRedireccionaVacanteAnterior {
	...
	public void setUp() throws Exception {
		...
		driver.get("https://www.choucairtesting.com/job/analista-de-pruebas/");// abrir dirección
	}
	...
	@Test
	public void testPruebaLinkPrepararseParaAplicar() {
		
		WebDriverWait wait = new WebDriverWait(driver, 10);//elemento agregar espera antes de dar el click para la otra pestaña
		WebElement searchbox= wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Practicante de Gestión de Talento Organizacional")));//buscar el link
		...
		assertEquals("Practicante de Gestión de Talento Organizacional – Choucair Testing", driver.getTitle());//comparación titulo pestaña
	}
