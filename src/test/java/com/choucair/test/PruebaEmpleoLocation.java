...
public class PruebaEmpleoLocation {
	...
	@Test
	public void testPruebaEmpleoLocation() {
		WebElement searchbox= driver.findElement(By.name("search_location"));//buscar q (cuadro de búsqueda)
		searchbox.clear();//limpiar el elmento q
		searchbox.sendKeys("medellin");//digite el texto
		...
		WebElement resulElement= driver.findElement(By.cssSelector("div[class=\"showing_jobs wp-job-manager-showing-all\"]"));
