...
public class PruebaRedireccionVacanteSiguiente {
	...
	@Test
	public void testPruebaRedireccionVacanteSiguiente() {
		WebDriverWait wait = new WebDriverWait(driver, 10);//elemento agregar espera antes de dar el click para la otra pestaña
		WebElement searchbox= wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Aprendiz TI")));//buscar el link
		...
		assertEquals("Aprendiz TI – Choucair Testing", driver.getTitle());//comparación titulo pestaña
	}
