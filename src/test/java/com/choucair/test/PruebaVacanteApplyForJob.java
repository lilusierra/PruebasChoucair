...
public class PruebaVacanteApplyForJob {
	...
	public void setUp() throws Exception {
			...
			driver.get("https://www.choucairtesting.com/job/aprendiz-ti//");// abrir dirección
	}
	...
	@Test
	public void testPruebaVacanteApplyForJob() {
		WebDriverWait wait = new WebDriverWait(driver, 10);//elemento agregar espera antes de dar el click para la otra pestaña
		WebElement searchbox= wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("input[value=\"Apply for job\"]")));//buscar el link
		...
		assertEquals("Aprendiz TI – Choucair TestingDetalle", driver.getTitle());//comparación titulo pestaña
	}
